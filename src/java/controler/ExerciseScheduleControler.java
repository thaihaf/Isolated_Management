 ...
 * @author Mountain
 */
public class ExerciseScheduleControler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Schedule_Exercise> se = seDB.listAllScheduleByRoom(r.getId());
        request.setAttribute("sched", se);
        request.getRequestDispatcher("../patient/exercise_sched.jsp").forward(request, response);
    }
